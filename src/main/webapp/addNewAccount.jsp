...
<head>
    ...
    <title>Bank.io - Add New Account</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--Sub Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add New Account</h1>
                    <p class="mb-4">Enter the information and click <strong>Submit</strong> to add a new account.</p>
                    ...
                    <div class="card">
					    <div class="card-body">
					        <form action="accountServlet" method="POST">
					            <div class="row">
					                <div class="col-6">
					                    <label for="bankName" class="form-label text-gray-800 font-weight-bold">Select the Appropriate Bank</label>
					                ...
					                <div class="col-6">
					                    <label for="accountType" class="form-label text-gray-800 font-weight-bold">What type of Account do you have?</label>
					            ...
					            <div class="row mt-4">
					                <div class="col-6">
					                    <label for="accountNumber" class="form-label text-gray-800 font-weight-bold">Enter your 10-digit Account Number</label>
					                    <input type="text" class="form-control" id="accountNumber" name="accountNumber" placeholder="e.g. 1234567890">
					                </div>            
					                <div class="col-6">
					                    <label for="balanceAmount" class="form-label text-gray-800 font-weight-bold">Your Current Balance Amount</label>
					                    <input type="text" class="form-control" id="balanceAmount" name="balanceAmount" placeholder="e.g. 5000000">
					                </div>
					            </div>
					            <div class="row mt-4">
					                <div class="col-12">
