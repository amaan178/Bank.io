...
<head>
    ...
    <title>Bank.io - Loan Calculator</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Loan Calculator</h1>
                    <p class="mb-4">Enter the required details in the input and click <strong>Calculate</strong></p>

                    <div class="loan-calculator">
                        <div class="top bg-gradient-primary">
                          <form action="#">
                            <div class="group">
                              <div class="title">Amount</div>
                              <input type="text" value="5000000" class="loan-amount" />
                            </div>
                  
                            <div class="group">
                              <div class="title">Interest Rate(% P.A)</div>
                              <input type="text" value="8.5" class="interest-rate" />
                            </div>
                  
                            <div class="group">
                              <div class="title">Tenure (in years)</div>
                              <input type="text" value="20" class="loan-tenure" />
                            </div>
                          </form>
                        </div>
                        ...
                        <div class="result">
                          <div class="left">
                            ...
                            <button class="calculate-btn bg-primary">Calculate</button>
                          </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Montran Project Bank.io 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
